...
Route::middleware(['auth'])->group(function () {
    ...
    // --- MÓDULO OPERACIONES ---
    Route::post('operaciones/ventas/{id}/anular', [\App\Http\Controllers\Operaciones\OperVentaController::class, 'destroy']);
    Route::get('operaciones/ventas/buscar', [\App\Http\Controllers\Operaciones\OperVentaController::class, 'search']); // New Route
