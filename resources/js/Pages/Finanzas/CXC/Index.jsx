...
export default function Index({ auth }) {
    ...
    const fetchData = async () => {
        try {
            const [cuentasRes, clientesRes] = await Promise.all([
                axios.get('/api/finanzas/cuentas-por-cobrar'),
    ...
    const handleRegistrarPago = async (e) => {
        ...
        try {
            await axios.post(`/api/finanzas/cuentas-por-cobrar/${selectedCuenta.id}/pago`, pagoData);
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <Card>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-secondary-600">Total por Cobrar</p>
                            <p className="text-2xl font-bold text-primary-600">{formatCurrency(totales.pendiente)}</p>
                        </div>
                ...
                <Card>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-secondary-600">Total Cobrado</p>
            ...
            <Card>
                ...
                {loading ? (
                    ...
                    <EmptyState
                        ...
                        description="No se encontraron documentos pendientes de cobro"
                    />
                ) : (
